[ch (id=script_nodes) [title Script Nodes]
    ...
    [ch [title Nodes]
        ...
        [ch (id=definition_node) [title Definition Node]
            ...
            Definitions can be imported with an [link url=[u:get pdml_docs_extensions_url]reference_manual/index.html#ins_file_node text=u:ins_file] node, or any other method that inserts text into a document.
            ...
            Here is an example of a fully functioning [link url=https://www.pml-lang.dev/ text=PML] file that uses a [c u:ins_file] node to import the definitions:
    ...
    [ch (id=script_nodes_syntax) [title Syntax]
        ...
        All script nodes ([c s:exp], [c s:script], and [c s:def]) are of type [link url=[u:get pdml_ext_ref_manual_url]#raw_text text=raw_text].
        ...
        For more information about the syntax rules, please refer to [link url=[u:get pdml_ext_ref_manual_url]#raw_text text=raw_text]
    ]
